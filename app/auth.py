...
# Словарь для хранения кодов верификации (в реальном приложении храните их в БД)
verification_codes = {}
...
async def verify_code(
    ...
    db.commit()
    del verification_codes[request.email]  # Удаляем код после успешной верификации
